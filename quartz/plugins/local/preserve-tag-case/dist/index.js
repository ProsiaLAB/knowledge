...
var require_failsafe2 = /* @__PURE__ */ __commonJSMin(((exports2, module2) => {
  module2.exports = new (require_schema2())({ explicit: [
    require_str2(),
    require_seq2(),
    require_map2()
  ] });
...
var require_json2 = /* @__PURE__ */ __commonJSMin(((exports2, module2) => {
  module2.exports = require_failsafe2().extend({ implicit: [
    require_null2(),
    require_bool2(),
    require_int2(),
    require_float2()
...
var require_loader2 = /* @__PURE__ */ __commonJSMin(((exports2, module2) => {
  ...
  function State(input, options2) {
    ...
    this.maxMergeSeqLength = typeof options2["maxMergeSeqLength"] === "number" ? options2["maxMergeSeqLength"] : 20;
    this.implicitTypes = this.schema.compiledImplicit;
    this.typeMap = this.schema.compiledTypeMap;
    this.length = input.length;
    this.position = 0;
          ...
          return (tree, file) => {
            ...
            try {
              ...
              const { data } = (0, import_gray_matter.default)(fileData, {
                engines: {
                  yaml: (s) => index_vite_proxy_tmp_default.load(s, { schema: index_vite_proxy_tmp_default.JSON_SCHEMA })
                }
              });
              ...
              if (originalTags && originalTags.length > 0) {
                const mappedTags = frontmatter.tags.map((sluggedTag) => {
                  const matchingOriginal = originalTags.find((orig) => {
...
var index_default = PreserveTagCase;
export {
  PreserveTagCase,
